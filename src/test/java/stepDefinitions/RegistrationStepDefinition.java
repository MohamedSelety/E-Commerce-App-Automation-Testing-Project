...
public class RegistrationStepDefinition {
    ...
    public void enterLastName(){
        registrationPage.setLastName("Selety");
    }

    @And("user selected birth of date")
    public void enterBirthOfDate(){
        registrationPage.setDayOfBirth(3);
        registrationPage.setMonthOfBirth("March");
        registrationPage.setYearOfBirth(1996);
    }

    @And("user entered email for registration")
    public void enterEmail(){
        registrationPage.setEmail("midoselety5@gmail.com");
    }
    @And("user entered company name")
    public void enterCompanyName(){
        registrationPage.setCompanyName("Anything");
    }
    @And("user entered password for registration")
    public void enterPassword(){
        registrationPage.setPassword("Moselety");
    }
    @And("user confirmed password for registration")
    public void confirmPassword(){
        registrationPage.confirmPassword("Moselety");
    }
